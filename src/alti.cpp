...
Alti::Alti(float x, float y, float z) {
    ...
    this->ring = create3DObject(GL_TRIANGLES, 360*3, ring_vertex_buffer_data, COLOR_YELLOW, GL_FILL);
...
void Alti::draw(glm::mat4 VP, float h, glm::vec3 eye, glm::vec3 target, glm::vec3 up, int camView, float zrotation){
    this->rotation = (-h/2500.0f)*180.f;
...
void Alti::set_position(float x, float y, float z){
