...
Fuel::Fuel(float x, float y, float z) {
    ...
    this->ring = create3DObject(GL_TRIANGLES, 360*3, ring_vertex_buffer_data, COLOR_GREEN, GL_FILL);
    ...
    this->object = create3DObject(GL_TRIANGLES, 3, vertex_buffer_data, COLOR_GREEN, GL_FILL);
}

void Fuel::draw(glm::mat4 VP, float curFuel, glm::vec3 eye, glm::vec3 target, glm::vec3 up, int camView, float zrotation){
    this->rotation = (-curFuel/100.0f)*180.f;
